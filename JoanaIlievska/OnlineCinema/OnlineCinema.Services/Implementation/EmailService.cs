...
namespace OnlineCinema.Services.Implementation
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(List<Email> allMails)
        {
            ...
            try
            {
                ...
                {
                    var socketOptions = _settings.EnableSsl ? SecureSocketOptions.StartTls : MailKit.Security.SecureSocketOptions.Auto;
