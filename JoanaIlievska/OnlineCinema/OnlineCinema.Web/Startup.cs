...
namespace OnlineCinema.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<OnlineCinemaApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
            ...
            //services.AddScoped<IBackgroundEmailSender, BackgroundSender>();
